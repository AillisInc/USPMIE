...
class StillGANModel(BaseModel):
    """This class implements the StillGAN model
    StillGAN paper: https://ieeexplore.ieee.org/document/9503421/
    """
    @staticmethod
    def modify_commandline_options(parser, is_train=True):
        ...
        Returns:
            the modified parser.
        """
        parser.set_defaults(no_dropout=True)  # did not use dropout by default
        if is_train:
            ...
            parser.add_argument('--Luminance_size1', type=int, default=32, # defaul: 48 
                                help='first window size for Luminance Loss')
            parser.add_argument('--Luminance_size2', type=int, default=64, # default: 96
                                help='second window size for Luminance Loss')
            parser.add_argument('--Structure_size', type=int, default=9, # default: 11
                                help='first window size for Structure Loss')
            parser.add_argument('--roi_size', type=int, default=256, # default: 384
